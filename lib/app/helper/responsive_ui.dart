...
class ResponsiveUI {
  ...
  final double _smallTabMultiplier = 0.8; //0.13;
  final double _largeTabMultiplier = 1.5; //0.17;
  final double _smallTabMultiplierFont = 0.3; //0.13;
  final double _largeTabMultiplierFont = 0.35; //0.17;
  ...
  double height(double i) {
    ...
    // Logger.print('ResponsiveUI:{Height} $value');
    return value;
  }
  ...
  double width(double i) {
    ...
    // Logger.print('ResponsiveUI:{width} $value');
    return value;
  }
  ...
  double fontSize(double i) {
    ...
    // Logger.print('ResponsiveUI:{font} $value');
    return value;
  }
}
